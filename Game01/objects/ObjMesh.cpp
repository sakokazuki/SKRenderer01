...
ObjMesh::ObjMesh(const char * fileName, bool center)
{
...
void ObjMesh::generateAveragedNormals(
...
void ObjMesh::storeVBO( const vector<vec3> & points,
                       const vector<vec3> & normals,
                       const vector<vec2> &texCoords,
...
void ObjMesh::trimString( string & str ) {
